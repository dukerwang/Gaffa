...
--
-- NOT YET APPLIED. Ships in the same update as the held-players work
-- (docs/superpowers/specs/2026-09-13-held-players-design.md), which rewrites
-- resolve_single_player_auction_rpc. Give this file the next free number and
-- apply it AFTER every migration that redefines that function, or a later
-- CREATE OR REPLACE will silently restore the old rule.
--
